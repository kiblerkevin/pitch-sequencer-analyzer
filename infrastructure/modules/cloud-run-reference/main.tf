...
variable "scheduler_service_account_email" {
  description = "Service account email for Cloud Scheduler to invoke Cloud Run jobs"
  type        = string
}

variable "image_tag" {
  description = "Image tag to deploy for the reference jobs"
  type        = string
  default     = "latest"
}
...
resource "google_cloud_scheduler_job" "daily_reference" {
